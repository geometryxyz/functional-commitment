...
pub struct Proof<F: PrimeField, PC: HomomorphicPolynomialCommitment<F>> {
    ...
    pub h1_seq_proof: Vec<u8>, // GeoSeqProof<F, PC>,
    pub h2_seq_proof: Vec<u8>, // GeoSeqProof<F, PC>,
    pub h_eq_row_m: Vec<u8>, // ZeroProof<F, PC>,
    pub row_m_eq_col_m: Vec<u8>, // ZeroProof<F, PC>,
    pub val_m_times_h2_proof: Vec<u8>, // ZeroProof<F, PC>,
    pub val_plus_h2_proof: Vec<u8>, // NonZeroProof<F, PC>,
}
